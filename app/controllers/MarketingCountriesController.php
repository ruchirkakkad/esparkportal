...
class MarketingCountriesController extends \BaseController
{
    ...
    public function getIndexdataView()
    {
        ...
        foreach ($returndata as $key => $val) {
            foreach ($val as $key1 => $val1) {
                $returndata[$key][$key1]['edit'] = "<a href='#/app/marketing_countries/edit/$val1[marketing_countries_id]'><button class='btn m-b-xs btn-sm btn-primary'><i class='fa fa-edit'></i></button></a>";
                $returndata[$key][$key1]['delete'] = "<a href='#/app/marketing_countries/delete/$val1[marketing_countries_id]'><button class='btn btn-sm btn-icon btn-danger'><i class='fa fa-trash-o'></i></button></a>";
            }
    ...
    {
        return Response::json(MarketingCountry::find($id));
    }

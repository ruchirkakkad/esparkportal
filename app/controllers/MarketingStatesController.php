...
class MarketingStatesController extends \BaseController {
    ...
    public function getIndexdataView()
    {
        ...
        foreach($data1 as $k => $v)
        {
            ...
            $returndata[$k]['edit'] = "<a href='#/app/marketing_states/edit/$v->marketing_states_id'><button class='btn m-b-xs btn-sm btn-primary'><i class='fa fa-edit'></i></button></a>";
            $returndata[$k]['delete'] = "<a href='#/app/marketing_states/delete/$v->marketing_states_id'><button class='btn btn-sm btn-icon btn-danger'><i class='fa fa-trash-o'></i></button></a>";
        }
    ...
    {
        return Response::json(MarketingState::find($id));
    }
